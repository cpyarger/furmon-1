...
def dfscript(sfile):
	...
	f.close()
	print 'dfscript function is done'
	# changemod to executable (stat.S_IXUSR), show result and execute the script
	dis="./"+sfile
	print "chmod +x start",dis
	os.chmod(dis, stat.S_IXUSR)
