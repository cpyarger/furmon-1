...
t11="test 1,1"
t12="test 1,2"
grep -e "^#html" $0 |cut -c 7-  |while read line; 
do 
 echo $line  >> outpcp.html # no change
 # if [[ $line==*$t11* ]]; then echo $(echo $line |sed "s|$t11 |$newrd1 |")  >> outpcp.html; else echo $line >> outpcp.html; fi
 # if [[ $line==*$t12* ]]; then echo $(echo $line |sed "s|$t12 |$newrd2 |")  >> outpcp.html; else echo $line >> outpcp.html; fi
done
